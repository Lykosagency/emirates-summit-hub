...
const faqs = [
  ...
  {
    q: "What exactly is included in the 5,000 AED investment?",
  ...
  },
  {
    ...
    a: "Smart casual to elevated business casual. Think clean, polished, and intentional. The environment is premium — dress accordingly.",
  },
  {
    q: "What happens after the event?",
    a: "Selected members gain continued access to the Cashflow Dubai private network, including future events, exclusive content, and direct lines to the community of operators you'll meet during the mastermind.",
  },
];
