...
const days = [
  {
    title: "Day 1 — Clarity & Selection",
    copy: "Choose the model that fits you. Lock your direction. Leave Day 1 with a decision.",
  },
  {
    title: "Day 2 — Build & Position",
    copy: "Create your asset. Build authority. Position your offer so the market understands it fast.",
  },
  {
    title: "Day 3 — Launch & Monetize",
    copy: "Execute the launch. Activate outreach and conversion. Build momentum and accountability.",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-6">
            The <span className="gold-text">Promise</span>
          </h2>
