...
const rows = [
  {
    ...
    description: "Your entry is personal, verified, and built for premium control.",
  ...
  },
  {
    ...
    description: "A simple signal that changes how you're perceived inside the room.",
  ...
  },
  {
    ...
    description: "A status object — built to represent access and private network entry.",
...
function FeatureRow({ row, index }: { row: (typeof rows)[0]; index: number }) {
  ...
  const imageBlock = (
    <div className="flex items-center justify-center">
      <img
        ...
        alt={row.imageAlt}
        loading="lazy"
        className="w-full h-[300px] sm:h-[350px] lg:h-[400px] object-contain drop-shadow-[0_20px_40px_hsla(43,56%,52%,0.12)] animate-float"
      />
    </div>
  );
  ...
  return (
    <div
      ref={ref}
      className={`grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center transition-all duration-1000 ${
